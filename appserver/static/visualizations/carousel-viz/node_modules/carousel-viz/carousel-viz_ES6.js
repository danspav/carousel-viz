	...
	numberWithCommas(x){
		...
		getHTML(){
			...
			if (this.unitPosition == "before") {
				...
				html += '<div class="value"><span valueField="' + this.valueField + '" rawValue="' + vizUtils.escapeHtml(this.value) + '">' + unitHTML + this.getValue() + '</span></div>';
			} else {
				unitHTML = (this.unit!="") ? '&thinsp;' + this.unit  : "";
				html += '<div class="value"><span valueField="' + this.valueField + '" rawValue="' + vizUtils.escapeHtml(this.value) + '">' + this.getValue() + unitHTML +'</span></div>';
			}
