class carousel_viz{
	constructor(){
		...
		this.tokenRawValue = "cv_value";
		this.tokenFormattedValue = "cv_value";
	...
	start(){
		...
		if (this.isVertical) { this.showDots = false;}
			...
			if(this.size == "automatic"){
				...
				if(this.maxFontSizes[this.size]) { maxFontSize = this.maxFontSizes[this.size];}
			}
	...
	numberWithCommas(x){
		...
		getHTML(){
			...
			if(this.unitPosition=="before"){
				html += '<div class="value"><span valueField="' + this.valueField + '" rawValue="' + vizUtils.escapeHtml(this.value) + '" data-unit="' + vizUtils.escapeHTML(this.unit) + '">' + this.unit + '&thinsp;'+  this.getValue() +  '</span></div>';
			}else{
				html += '<div class="value"><span valueField="' + this.valueField + '" rawValue="' + vizUtils.escapeHtml(this.value) + '" data-unit="' + vizUtils.escapeHTML(this.unit) + '">' + this.getValue() + '&thinsp;' + this.unit +  '</span></div>';
			}
