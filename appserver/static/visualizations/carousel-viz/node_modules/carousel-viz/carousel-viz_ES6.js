class carousel_viz{
	...
	getHTML(){
		console.log("I'm possbily a new object. My height is: " + this.height);
		var html = "";
		var dir = "";
	...
	resize(height){
		...
		if(objCarousel.size != "automatic"){
			...
			console.log("Resize function entered.");
			console.log("Given Size: " + height);
			console.log("Final size changed to:" + newHeight);
