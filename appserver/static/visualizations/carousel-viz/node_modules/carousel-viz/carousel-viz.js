class carousel_viz{
	...
	start(){
			...
			window.jQuery("div#" + this.id + " div.value").textfill({ allowOverflow: false, changeLineHeight: true, maxFontPixels: objCarousel.maxFontSizes[objCarousel.size], widthOnly: true });
	...
	resize(height){
		...
		setTimeout(function(){ 
			window.jQuery("div#" + objCarousel.id + " div.value").textfill({ allowOverflow: false, changeLineHeight: true, maxFontPixels: objCarousel.maxFontSizes[objCarousel.size], widthOnly: true });
			window.jQuery("div#" + objCarousel.id + " div.caption").textfill({ allowOverflow: false, changeLineHeight: false, maxFontPixels: 18, minFontPixels: 8 });
		},1000);
	}
