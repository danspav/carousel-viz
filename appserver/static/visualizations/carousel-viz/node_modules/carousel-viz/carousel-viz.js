class carousel_viz{
	constructor(){
		...
		this.validSizes={"xsmall":75,"small":100,"medium":250,"large":300,"xlarge":500};
	...
	resize(height){
		var objCarousel=this;
		objCarousel.height = height;
		var maxFontSize = (.8 * objCarousel.height * .8) - 15; // .8 is the CSS height for the value div, and take 80% of that, minus 15 to allow for padding.
	...
	*/
	class carousel_viz_slide{
		...
		getStyle(){
			...
			if (this.size=="automatic"){ style="medium";}
