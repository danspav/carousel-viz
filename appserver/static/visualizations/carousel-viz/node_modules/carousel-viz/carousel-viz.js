class carousel_viz{
	...
	resize(height){
		...
		if(isVertical){
			...
			maxCaptionSize = ((.2* slideHeight) - 10) < 6 ? 6 : (.2* slideHeight) - 10;
		...
		setTimeout(function(){ 
			window.jQuery("div#" + objCarousel.id + " div.value").textfill({ allowOverflow: false, changeLineHeight: false, maxFontPixels: maxFontSize,minFontPixels: 12, widthOnly: true });
			window.jQuery("div#" + objCarousel.id + " div.caption").textfill({ allowOverflow: false, changeLineHeight: false, maxFontPixels: maxCaptionSize, minFontPixels: 6,widthOnly: true });
		},1000);
	}
