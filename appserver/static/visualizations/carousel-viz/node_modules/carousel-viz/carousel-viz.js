class carousel_viz{
	...
	start(){
			...
			maxFontSize = (.8* objCarousel.height * .8); // .8 is the CSS height for the value div, and take 80% of that to allow for padding.
	...
	resize(height){
		var objCarousel=this;
		objCarousel.height = height;
		maxFontSize = (.8* objCarousel.height * .9); // .8 is the CSS height for the value div, and take 90% of that to allow for padding.
