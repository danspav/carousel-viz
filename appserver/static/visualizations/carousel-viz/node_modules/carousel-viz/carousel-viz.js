class carousel_viz{
	...
	setConfig(config, namespace){
		...
		this.showArrows = vizUtils.escapeHtml(config[namespace + 'showArrows']) || false; 
	...
	start(){
				...
				var sizes = {xsmall:70,small:95,normal:145,large:195,xlarge:225}
				...
				window.jQuery("div#" + this.id + " div.value").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:sizes[objCarousel.size],widthOnly:false});
				window.jQuery("div#" + this.id + " div.caption").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:18,minFontPixels:12});
