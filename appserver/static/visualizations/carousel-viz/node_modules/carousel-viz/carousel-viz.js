	...
	numberWithCommas(x){
		...
		getHTML(){
			...
			if(this.unitPosition=="before"){
				html += '<div class="value"><span class="unit">' + this.unit + '&thinsp;</span><span class="val" valueField="' + this.valueField + '">' +  this.getValue() +  '</span></div>';
			}else{
				html += '<div class="value"><span class="val" valueField="' + this.valueField + '">' + this.getValue() + '</span><span class="unit">&thinsp;' + this.unit +  '</span></div>';
			}
