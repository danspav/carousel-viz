class carousel_viz{
	...
	start(){
		...
		var isVertical = (this.orientation=="vertical");
			...
			var maxFontSize = (.8* objCarousel.height ); // .8 is the CSS height for the value div, and take 80% of that to allow for padding.
	...
	resize(height){
		var objCarousel=this;
		objCarousel.height = height;
		var maxFontSize = (.8 * objCarousel.height ) - 15; // .8 is the CSS height for the value div, and take 80% of that, minus 15 to allow for padding.
