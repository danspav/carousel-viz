class carousel_viz{
	...
	getHTML(){
		var html = "";
		var i =0;
		 html ='<section class="center slider">';
		 ...
		 return html;
			...
			start(){
					...
					window.jQuery("div.value").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:1000});
					window.jQuery("div.caption").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:18});
					
					
				/*	 window.jQuery('.center').slick({
				  centerMode: true,
				  infinite: true,
				  variableWidth: true,
				  centerPadding: '60px',
