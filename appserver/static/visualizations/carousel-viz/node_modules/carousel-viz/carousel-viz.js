class carousel_viz{
	...
	resize(height){
		...
		if(isVertical && objCarousel.slidesToShow>1){
			evenHeight = Math.floor((.9*height)/objCarousel.slidesToShow -15);
			if(evenHeight%2==1) { evenHeight -=1;}
			window.jQuery("div#" + this.id).height(evenHeight* objCarousel.slidesToShow+15);
			window.jQuery("div#" + this.id +" div.singlevaluebox").height(evenHeight);
