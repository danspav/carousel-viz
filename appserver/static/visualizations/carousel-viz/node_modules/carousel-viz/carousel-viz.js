class carousel_viz{
	...
	resize(height){
		...
		//	maxFontSize = (.7 * verticalSlideHeight ) - 15; // take 70% of the CSS height for the value div to allow for padding.
			verticalSlideHeight = Math.ceil(height/objCarousel.slidesToShow -30) // Allow 30px for the dots, allow 5 for borders and padding for each slide
			window.jQuery("div#" + this.id).height(verticalSlideHeight + 30);
			window.jQuery("div#" + this.id +" div.singlevaluebox").height(verticalSlideHeight);
			maxFontSize = (.7 * verticalSlideHeight ) - 15; // take 70% of the CSS height for the value div to allow for padding.
