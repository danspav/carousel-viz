class carousel_viz{
	...
	setConfig(config, namespace){
		...
		this.isSplunkDarkMode = (visUtils.getCurrentTheme=="dark");
	...
	start(){
				...
				if(this.size=="xsmall"){
					window.jQuery("div#" + this.id + " div.value").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:70,widthOnly:true});
					...
					window.jQuery("div#" + this.id + " div.value").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:200,widthOnly:true});
					window.jQuery("div#" + this.id + " div.caption").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:18,minFontPixels:8});
				}
