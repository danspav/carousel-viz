 ...
 */
define(['jquery', 'underscore', 'api/SplunkVisualizationBase', 'api/SplunkVisualizationUtils', 'carousel-viz', 'textfill', 'slick', 'splunkjs/mvc'

// Add required assets to this list
], function ($, _, SplunkVisualizationBase, vizUtils, carousel_viz, textfill, slick, mvc) {
	...
	return SplunkVisualizationBase.extend({
		...
		setTokens: function setTokens(aTokens) {
			for (var tok in aTokens) {
				this._setToken(aTokens[tok]['key'], aTokens[tok]['value']);
			}
		},

		_setToken: function _setToken(name, value) {
		...
		drilldownToCategory: function drilldownToCategory(categoryName, categoryFieldValue, browserEvent) {
			var data = {};
