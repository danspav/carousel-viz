	...
	getHTML(){
		...
		var i =0;
		 ...
		 return html;
			...
			start(){
				window.jQuery("div#" + this.id + " > div.value").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:1000});
				window.jQuery("div#" + this.id + " > div.caption").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:18});
