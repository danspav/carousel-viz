class carousel_viz{
	...
	resize(height){
		...
		if(isVertical && objCarousel.slidesToShow>1 && objCarousel.slidesToShow<=3){
			...
			window.jQuery("div#" + this.id).height(verticalSlideHeight * objCarousel.slidesToShow + 10);
		...
		}else if (isVertical && objCarousel.slidesToShow >3){
			if(isVertical && objCarousel.slidesToShow>1){
			verticalSlideHeight = Math.ceil(0.9*(height/objCarousel.slidesToShow)) // Allow 15px for the dots, allow 5 for borders and padding
