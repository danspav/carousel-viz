class carousel_viz{
	...
	resize(height){
		...
		if(isVertical && objCarousel.slidesToShow>3 || objCarousel.slidesToShow==1){
		...
		//	maxFontSize = (.7 * verticalSlideHeight ) - 15; // take 70% of the CSS height for the value div to allow for padding.
			verticalSlideHeight = Math.ceil(0.9*((height/objCarousel.slidesToShow)-5)) -30 // Allow 30px for the dots, allow 5 for borders and padding for each slide
			window.jQuery("div#" + this.id).height(0.9*height);
			window.jQuery("div#" + this.id +" div.singlevaluebox").height(verticalSlideHeight);
			maxFontSize = (.7 * verticalSlideHeight ) - 15; // take 70% of the CSS height for the value div to allow for padding.
			
		} else if(isVertical && (objCarousel.slidesToShow==2 || objCarousel.slidesToShow==3)){
			verticalSlideHeight = Math.floor(0.9*((height/objCarousel.slidesToShow)-2* objCarousel.slidesToShow)) // Allow 15px for the dots, allow 5 for borders and padding
			window.jQuery("div#" + this.id).height(0.9*height) -30; // 30 is to allow for dots
			//window.jQuery("div#" + this.id +" div.singlevaluebox").height(verticalSlideHeight);
			maxFontSize = (.7 * verticalSlideHeight ) - 15; // take 70% of the CSS height for the value div to allow for padding.
