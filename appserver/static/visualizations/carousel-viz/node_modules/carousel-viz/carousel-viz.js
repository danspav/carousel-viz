class carousel_viz{
	...
	setData(data){
			...
			try{
				...
				for (i=0; i<data.rows.length; i++){
					...
					if (typeof fields["caption"] ==='undefined' || data_item[fields["caption"]]==""){ oSlide.caption = this.defaultCaption;} else {vizUtils.escapeHtml(data_item[fields["caption"]]);}
					if (typeof fields["range"] ==='undefined' || data_item[fields["range"]]==""){ oSlide.range = "default";}else{vizUtils.escapeHtml(data_item[fields[rangeFieldName]]);}
	...
	start(){
				...
				window.jQuery("section#" + this.id + " div.caption").textfill({allowOverflow:false,changeLineHeight:true,maxFontPixels:18,minFontPixels:8});
