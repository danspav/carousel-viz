class carousel_viz{
	...
	start(){
		...
		var isVertical = (this.orientation=="vertical");
			...
			var maxFontSize = (.7* objCarousel.height ); // take 80% of the CSS height for the value div to allow for padding.
	...
	resize(height){
		...
		if(objCarousel.size=="automatic"){
			window.jQuery("div#" + this.id).height(.9*height);
			window.jQuery("div#" + this.id +" div.singlevaluebox").height(.9*height);
		}
