class carousel_viz{
	...
	start(){
		...
		var isVertical = (this.orientation=="vertical");
			...
			var maxFontSize = (.8* objCarousel.height ); // take 80% of the CSS height for the value div to allow for padding.
	...
	resize(height){
		var objCarousel=this;
		objCarousel.height = height;
		var maxFontSize = (.8 * objCarousel.height ) - 15; // take 80% of the CSS height for the value div to allow for padding.
